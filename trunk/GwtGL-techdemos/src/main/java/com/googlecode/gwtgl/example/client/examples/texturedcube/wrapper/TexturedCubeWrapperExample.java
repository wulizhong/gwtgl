 ...
 */
package com.googlecode.gwtgl.example.client.examples.texturedcube.wrapper;
 ...
 * 
 */
public class TexturedCubeWrapperExample extends AbstractGwtGLWrapperExample {
	...
	public TexturedCubeWrapperExample() {
		...
		HTML exampleDescription = new HTML(
				"<h2>Texture2D Wrapper Example</h2><h3>Controls</h3><p>PAGEGUP - Zoom in<br/>PAGEDOWN - Zoom out</p>");
