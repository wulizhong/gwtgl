...
public class Uint32ArrayTest extends GWTTestCase {
  ...
  public void testInitWithArrayBuffer() {
    ...
    ArrayBuffer arrayBuffer = ArrayBuffer.create(testData.length * Uint32Array.BYTES_PER_ELEMENT);
  ...
  public void testInitWithArrayBufferAndOffset() {
    ...
    ArrayBuffer arrayBuffer =
        ArrayBuffer.create((testData.length + 1) * Uint32Array.BYTES_PER_ELEMENT);

    Uint32Array array = Uint32Array.create(arrayBuffer, Uint32Array.BYTES_PER_ELEMENT);
  ...
  public void testInitWithArrayBufferAndOffsetAndLength() {
    ...
    ArrayBuffer arrayBuffer =
        ArrayBuffer.create((testData.length + 2) * Uint32Array.BYTES_PER_ELEMENT);

    Uint32Array array =
        Uint32Array.create(arrayBuffer, Uint32Array.BYTES_PER_ELEMENT, testData.length);
