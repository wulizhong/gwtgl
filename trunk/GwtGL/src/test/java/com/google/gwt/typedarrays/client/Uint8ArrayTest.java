...
public class Uint8ArrayTest extends GWTTestCase {
  ...
  public void testInitWithArrayBuffer() {
    ...
    ArrayBuffer arrayBuffer = ArrayBuffer.create(testData.length * Uint8Array.BYTES_PER_ELEMENT);
  ...
  public void testInitWithArrayBufferAndOffset() {
    ...
    ArrayBuffer arrayBuffer =
        ArrayBuffer.create((testData.length + 1) * Uint8Array.BYTES_PER_ELEMENT);

    Uint8Array array = Uint8Array.create(arrayBuffer, Uint8Array.BYTES_PER_ELEMENT);
  ...
  public void testInitWithArrayBufferAndOffsetAndLength() {
    ...
    ArrayBuffer arrayBuffer =
        ArrayBuffer.create((testData.length + 2) * Uint8Array.BYTES_PER_ELEMENT);

    Uint8Array array =
        Uint8Array.create(arrayBuffer, Uint8Array.BYTES_PER_ELEMENT, testData.length);
