...
public class Int16Array extends IntBasedTypedArray<Int16Array> {
	...
	/**
	 * Create a new Int16Array object of the given length with a new underlying ArrayBuffer large enough to hold length elements of the specific type. Data in the buffer is initialized to 0.
	 * 
	 * @param length
	 * @return the created Int16Array
	 */
	...
	/**
	 * Create a new Int16Array object with a new underlying ArrayBuffer large enough to hold the given data, then copy the passed data into the buffer.
	 * 
	 * @param array
	 * @return the created Int16Array
	 */
	public static native Int16Array create(Int16Array array) /*-{
	...
	private static native Int16Array innerCreate(int[] array) /*-{
		return new Int16Array(array);
	}-*/;
	
	private static native Int16Array innerCreate(JsArrayInteger array) /*-{
		return new Int16Array(array);
	}-*/;
	
	/**
	 * Create a new Int16Array object using the passed ArrayBuffer for its storage.
	 * 
	 * @param buffer
	 * @return the created Int16Array
	 */
	 ...
	 * @return the created Int16Array
	 */
	public static native Int16Array create(ArrayBuffer buffer, int byteOffset, int length) /*-{
