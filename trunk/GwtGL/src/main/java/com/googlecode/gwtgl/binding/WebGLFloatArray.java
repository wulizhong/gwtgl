...
public class WebGLFloatArray extends WebGLArray<WebGLFloatArray> {
	 ...
	 * @return the created WebGLFloatArray
	 */
	public static native WebGLFloatArray create(WebGLArrayBuffer buffer) /*-{
	 ...
	 * @return the created WebGLFloatArray
	 */
	public static native WebGLFloatArray create(WebGLArrayBuffer buffer, int byteOffset) /*-{
	 ...
	 * @param array
	 */
	public final native void set(WebGLFloatArray array) /*-{
		this.set(array);
	}-*/;
